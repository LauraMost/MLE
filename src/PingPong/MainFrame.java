...
import static PingPong.Agent.X_BALL;

@SuppressWarnings("serial")
public class MainFrame extends JFrame {

    private boolean fastMode = true;
    private int numOfSteps = 1000;
    private int learning = 100000;
    ...
    public void run() {
        ...
        while (!stop) {
            ...
            int action = agent.calcNextAction(xBall, yBall, xSchlaeger, xV, yV, lastReward);// (2.0 * Math.random() - 1.0); // TODO Agent
